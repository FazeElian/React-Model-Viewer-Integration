...
export default function WolfSpiderCharacter() {
    ...
    return (
        <div className="cont-card-character">
            <model-viewer className="cont-caracter-card" src="./model/WolfSpider.glb" ar ar-modes="webxr scene-viewer quick-look" 
