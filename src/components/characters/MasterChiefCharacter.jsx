...
export default function MasterChiefCharacter() {
    ...
    return (
        <div className="cont-card-character">
            <model-viewer className="cont-caracter-card" src="./model/MasterChief.glb" ar ar-modes="webxr scene-viewer quick-look" 
